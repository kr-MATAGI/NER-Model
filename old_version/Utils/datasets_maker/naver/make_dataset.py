...
'''
    ...
    https://github.com/huggingface/transformers/issues/323
'''
...
def make_X_tag_npy(src_list: List[NAVER_NE], save_path: str, mode: str, model_name: str, max_len: int = 512) -> None:
    print(f"mode: {mode}, src_list.len: {len(src_list)}")
