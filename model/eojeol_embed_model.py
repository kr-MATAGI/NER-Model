...
class Eojeol_Embed_Model(ElectraPreTrainedModel):
    def __init__(self, config):
        ...
        # structure
        self.electra = ElectraModel.from_pretrained(self.model_name, config=config)
        classifier_dropout = (
    ...
    def forward(
            ...
            pos_tag_ids=None, span_ids=None, eojeol_ids=None, input_seq_len=None, labels=None
    ):
        # POS Embedding
        ...
        self._make_eojeol_tensor(last_hidden=el_last_hidden, pos_ids=pos_tag_ids, eojeol_ids=eojeol_ids)