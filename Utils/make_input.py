...
if "__main__" == __name__:
    ...
    if is_make_nikl:
        ...
        is_split_pkl = True
        if is_split_pkl:
            with open("../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_datasets.pkl", mode="rb") as origin_file:
                ...
                with open("../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_train.pkl", mode="wb") as train_file:
                    pickle.dump(train_data_list, train_file)
                with open("../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_eval.pkl", mode="wb") as eval_file:
                    pickle.dump(eval_data_list, eval_file)
                with open("../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_test.pkl", mode="wb") as test_file:
                    pickle.dump(test_data_list, test_file)

        # make npy
        train_maker = Npy_Input_Maker(pkl_path="../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_train.pkl",
                                      tokenizer_name="monologg/koelectra-base-v3-discriminator")
        train_dict = train_maker.make_input_labels()
        train_maker.make_npy_files(src_dict=train_dict, save_path="../datasets/NIKL/npy/filtered/train")

        eval_maker = Npy_Input_Maker(pkl_path="../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_eval.pkl",
                                     tokenizer_name="monologg/koelectra-base-v3-discriminator")
        eval_dict = eval_maker.make_input_labels()
        eval_maker.make_npy_files(src_dict=eval_dict, save_path="../datasets/NIKL/npy/filtered/eval")

        test_maker = Npy_Input_Maker(pkl_path="../datasets/NIKL/res_nikl_ne/filtered_nikl_ne_test.pkl",
                                     tokenizer_name="monologg/koelectra-base-v3-discriminator")
        test_dict = test_maker.make_input_labels()
        test_maker.make_npy_files(src_dict=test_dict, save_path="../datasets/NIKL/npy/filtered/test")